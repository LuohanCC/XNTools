...
@interface XNIndefiniteAnimatedView ()

@property (nonatomic, strong) CAShapeLayer *indefiniteAnimatedLayer;

@end

@implementation XNIndefiniteAnimatedView
...
- (CAShapeLayer*)indefiniteAnimatedLayer {
    if(!_indefiniteAnimatedLayer) {
        ...
        NSString *path = [imageBundle pathForResource:@"angle-mask02" ofType:@"png"];
        ...
        _indefiniteAnimatedLayer.lineWidth = 100;
...
- (void)setStrokeThickness:(CGFloat)strokeThickness {
    ...
    _indefiniteAnimatedLayer.lineWidth = 40;
}
